...
|---|---|---|---|
| P0 | Lokale Finanzdatei, SQLite-WAL, Migrationen, Audit | Erfüllt | Migrationen 1–27, Integritätstest, append-only Auditereignisse |
...
2. Den vorhandenen pain.001-/pain.008-/pain.002-Kern mit weiteren
   synthetischen Bankvarianten härten; danach EPC-QR und einen versionierten
