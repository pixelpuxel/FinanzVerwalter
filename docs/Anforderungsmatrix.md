...
|---|---|---|---|
| P0 | Lokale Finanzdatei, SQLite-WAL, Migrationen, Audit | Erfüllt | Migrationen 1–29, Integritätstest, append-only Auditereignisse |
...
| P0 | Berichte, Druck und Export | Teilweise | Live-Querymodell mit allen P0-Filtern, Splitauflösung ohne Doppelzählung, zwei frei kombinierbaren Gruppierungsdimensionen, währungsgetrennten Gruppen, Drill-down, rückwärtskompatiblen versionierten Vorlagen, sechs editierbaren buchungsbasierten Standardberichten sowie einem echten historischen Stichtagsbericht für Kontosalden/Nettovermögen mit Konto-/Gruppen-/Währungsfiltern, Eröffnung/Bewegungen/Saldo und getrennten Aktiva-/Passiva-/Nettosummen vorhanden; CSV-Golden-Tests und mehrseitige A4-PDFs in Hoch-/Querformat sind semantisch geprüft; Kontoblatt und Berichtswerkstatt besitzen direkten Systemdruck über denselben PDF-Datenstrom wie der Export; Zeit-/Budgetvergleich sowie XLSX/HTML fehlen |
