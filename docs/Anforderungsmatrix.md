...
| P0 | Berichte, Druck und Export | Teilweise | Live-Querymodell mit allen P0-Filtern, Splitauflösung ohne Doppelzählung, zwei frei kombinierbaren Gruppierungsdimensionen, währungsgetrennten Gruppen, Drill-down, rückwärtskompatiblen versionierten Vorlagen, CSV-Golden-Test und mehrseitigem A4-PDF in Hoch-/Querformat mit semantischem Test und Renderprüfung vorhanden; Kontoblatt und Berichtswerkstatt besitzen direkten Systemdruck über denselben PDF-Datenstrom wie der Export; weitere Standardberichte sowie XLSX/HTML fehlen |
