...
|---|---|---|---|
| P0 | Lokale Finanzdatei, SQLite-WAL, Migrationen, Audit | Erfüllt | Migrationen 1–24, Integritätstest, append-only Auditereignisse |
...
| P1 | Zahlungsverkehr | Teilweise | SEPA-/Echtzeit-/Terminauftrag, unveränderlicher Empfänger-/Bankdaten-Schnappschuss, SEPA-Core-Lastschrift mit Gläubiger-ID, Bankverbindung, Mandat, doppelter Bestätigung und genau-einmaliger Gutschrift, SCA-Simulation, Idempotenz, versionierte pain.001.001.09- und pain.008.001.08-Exporte sowie lokale Daueraufträge mit Pause/Ende, Wochenendregel, genau-einmaliger Entwurfserzeugung und Historie; Feiertagskalender, Sammler, EPC-QR sowie pain.001-/pain.008-Import und pain.002 fehlen |
...
2. Sammelüberweisungen und Sammellastschriften mit atomarer Vorschau,
   Gesamtsummen und versionsgebundenem ISO-20022-Export ergänzen.
